...
/*
 * Maze Adventure Game Component - Updated for Redis/Username support
 * All API calls now include username parameter for multi-user support
 */
...
// Reusable API function - Updated to include username
const apiCall = async (url, method = 'GET', body = null) => {
  ...
  // Add username to URL
  const urlWithUsername = `${url}?username=${encodeURIComponent(username)}`;
  ...
  const res = await fetch(urlWithUsername, options);
